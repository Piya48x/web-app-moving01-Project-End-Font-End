...
function FollowDriverComponent() {
  ...
  {order ? (
    <>
      ...
      <div  style={{borderRadius: '50px'}} className="container mx-auto p-4">
        {order && (
          <>
            <div style={{borderRadius: '50px'}} className="border border-gray-300 p-4 mb-4 rounded-lg">
        ...
        <div
          className="flex flex-col space-y-2 overflow-y-auto bg-gray-100 p-4 rounded-lg"
          ...
          {messages.map((msg, index) => (
            <div
              ...
              className={`p-2 rounded-lg ${
                msg.sent
                  ? "mr-4 bg-blue-500 text-white self-end"
